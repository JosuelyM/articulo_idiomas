...
time\cgnote{hay tiempo en estas curvas? son s\'olo del 2002. Tal vez
simplemente quitar `time'}, Zipf's law is observed. \cgnote{convendr\'ia poner
una curva ``ideal'' (tal vez punteada) en cada panel, para ver qu\'e tanto se
desv\'ian los datos de la ley de Zipf. Hay alguna correlaci\'on entre la
influencia de un idioma en otro y la pendiente de estas curvas? Me imagino que
mientras mayor sea el \'area (pendiente menos pronunciada), esto implica que
hay mayor influencia}}
