...
\hlineB{4.5}
	...
	& \begin{tabular}[c]{@{}c@{}}duce, mussolini, \\ panzer\cgnote{tal vez quitarla? panzer viene del alem\'an}, regime.\end{tabular}                                                                             & IT                       & \begin{tabular}[c]{@{}c@{}}EN (1930), FR (1930),\\ GE (1930, 1940),\\ SP (1930).\end{tabular}                        \\
...
etc). \cgnote{How many time slices were used? For which years/decades?} With this, it can be concluded that, the migrant accumulated words in the
...
words (less frequent). \cgnote{For these plots I would also suggest to have all plots with the same $y$ scale (0..1). If this would take several days, not to delay the submission, it would be OK to submit as it is now, and correct the figures while the paper is under review.}
