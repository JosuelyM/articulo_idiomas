...
\hlineB{4.5}
	...
	& \begin{tabular}[c]{@{}c@{}}duce, mussolini, \\ panzer\cgnote{tal vez quitarla? panzer viene del alem\'an} \jmnote{ya lo revise y fue un error del metodo en la clasificacion, desde la tesis tengo mal calfisicada esta palabra :S, lo mejor es quitarla } regime.\end{tabular}                                                                             & IT                       & \begin{tabular}[c]{@{}c@{}}EN (1930), FR (1930),\\ GE (1930, 1940),\\ SP (1930).\end{tabular}                        \\
...
etc). \cgnote{How many time slices were used? For which years/decades?} \jmnote{la diversidad de rango se calculo para cada año entre 1900 y 2009, el conteo fue por año no por decada.}With this, it can be concluded that, the migrant accumulated words in the
...
\jmnote{Para la robustes se eliminaron palabras migrantes de un idioma en otro, y a partir de la eliminacion se calculo el uso ec1. Con ello ya se tienen dos curvas una original (con las frecuencias de todas las palabras migrantes) y otra que es una fraccion o porcion de ella (algunas frecuencias de las palabras migrantes); para ver que tan similares son se normalizo cada una por su valor promedio y se calculo ec3. La razon de que las graficas no esten con la misma escala esque la normalizacion del promedio no ajusta los valores entre cero y uno, solo sabemos que entre mas pequeña sea la distancia la similitud es mejor.  }
