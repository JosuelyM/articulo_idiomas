...
For the development of this work,  we used the Google Books $N$-gram dataset~\cite{ngramv}.
...
words such as nouns, main verbs, adjectives and adverbs, which are responsible
for the information in the message. Although the names of people, countries and
...
The previous criteria for searching words with the same spelling and later
...
separated by the origin of the different NMW. \cgnote{en ejes $x$ mejor poner 'Year', en eje $y$ no ser\'ia NMW?}
% 
% Among language
