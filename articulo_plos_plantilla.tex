...
\begin{flushleft}
	{\Large
		\textbf\newline{Statistical analysis of 1-gram flow among Indo-European languages \cgnote{Statistical analysis of word flow among six Indo-European languages}} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
	}
	\newline
...
the original or receiving language,  the lower ranks are always occupied by fewer words, and as the rank increases, the diversity curve also increases logarithmically. 
