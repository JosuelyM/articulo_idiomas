...
separated by the origin of the different NMW. \cgnote{en ejes $x$ mejor poner 'Decade', en eje $y$ no ser\'ia NMW?}
% 
% Among language
...
Other interesting feature that we observed is that migrant words still 
fulfill Zipf's law. In Fig~\ref{fig.ZL_receiving} we present all language pairs, 
grouped by receiving language and we observe, 
within statistical fluctuations, an asymptotic power-law decay with exponent
close to one.
