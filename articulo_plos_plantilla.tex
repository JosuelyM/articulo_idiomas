...
shows how much influence the things have\cpnote{Esta frase es muy importante,
pero no estoy del todo de acuerdo con ella. Platicar con Josue y con CarlosG}.
We built a first method to quantify \jmnote{platicar con carlos} \cpnote{Entonces lo 
que dice Josue es que tenemos que justificar el contar las palabras como una forma 
de cuantificar la influencia de un idioma sobre otro. } the influence
that one language has on another, this consisted of analyzing the
