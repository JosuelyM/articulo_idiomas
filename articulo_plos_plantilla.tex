...
\caption{{\bf Rank diversity of accumulated migrant words among languages.} All
language pairs show a logarithmic behavior regardless of the number of ranks
...
\beta$ to fit the rank diversity; the parameters $\alpha$ and $\beta$
are obtained with a linear regression (the reliability of the fit with the
...
corresponding to each language pair. It is observed that the behavior of
