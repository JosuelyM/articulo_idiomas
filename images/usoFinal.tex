...
%     \node at (-3.2,2.4) [anchor=west] {\footnotesize Random channel};
    \node at (0,0*3)  {\includegraphics{prevolucion1.pdf}};
    \node at (1*5.2,0*3)  {\includegraphics{prevolucion2.pdf}};
    \node at (2*5.2,0*3)  {\includegraphics{prevolucion3.pdf}};
    \node at (0,-1*3.3)  {\includegraphics{prevolucion4.pdf}};
    \node at (1*5.2,-1*3.3)  {\includegraphics{prevolucion5.pdf}};
