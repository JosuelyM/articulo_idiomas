...
%     \node at (-3.2,2.4) [anchor=west] {\footnotesize Random channel};
    \node at (0,0)         {\includegraphics{ds1.pdf}};
    \node at (1*5.2,0)     {\includegraphics{ds2.pdf}};
    \node at (2*5.2,0)     {\includegraphics{ds3.pdf}};
    \node at (0,\tmp)      {\includegraphics{ds4.pdf}};
    \node at (1*5.2,\tmp)  {\includegraphics{ds5.pdf}};
    \node at (2*5.2,\tmp)  {\includegraphics[scale=1.2]{prevolucion_legendas.pdf}};
